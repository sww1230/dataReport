      ...
      content:{
        data: {
          ...
          chartExtend:{
            ...
            'xAxis.1.axisLabel.rotate': -35,
            // 'xAxis.0.axisPointer.label.formatter': function (params) {
            //   return params.value +' '+  params.seriesData[0].data[1];
            // },
            // 'xAxis.1.axisPointer.label.formatter': function (params) {
            //   return params.value //+' '+  params.seriesData[1].data[1];
            // }
          },
          chartSettings: {
            // xAxisType: 'time',
